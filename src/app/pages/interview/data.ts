...
let question = [
  ...
  },
  {
    "Q":
      [
        "你能与我分享你的四级/ 六级或参加过的托福或雅思成绩吗？—Intellectual",
        "请一般、良好和优秀的来评价自己的英语口语水平。—Self Awareness",
        "请用英文做一个自我介绍。—Intellectual",
        "能分享一下你在一个讲英语的环境中交流的经验？英语是否曾经作为工作语言？—Experience",
        "在以往的实习经历中是否参与过global的项目？可以share一下项目细节吗？—Experience",
        "Others—Intellectual"
      ],
    "Desc":
